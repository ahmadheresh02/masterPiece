                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                ...
                                >
                                <label for="remember" class="form-check-label ml-2 text-sm font-medium text-[var(--text-dark)]">
                                    Remember Me
                                </label>
                            </div>
                            ...
                            <div class="flex flex-col md:flex-row items-center justify-between mt-6">
                                <button
                                    type="submit"
                                    class="search-btn w-full md:w-auto mb-3 md:mb-0"
                                >
                                ...
                                @if (Route::has('password.request'))
                                    <a class="text-[var(--primary-color)] hover:underline text-sm" href="{{ route('password.request') }}">
                            ...
                            <div class="border-t border-[var(--border-color)] pt-4 mt-6 text-center">
                                <p class="text-[var(--text-light)] text-sm">
                                    ...
                                    <a href="{{ route('register.step1') }}" class="text-[var(--primary-color)] hover:underline font-medium">
                                        Create an account
                                    </a>
                                </p>
                            </div>
