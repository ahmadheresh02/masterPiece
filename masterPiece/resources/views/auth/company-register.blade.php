                ...
                <div class="search-container glass-card p-6">
                    ...
                    <form action="{{ route('company.register.post') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- Company Name -->
                            <div>
                                <label for="name" class="block text-sm font-medium text-[var(--text-dark)] mb-1">Company Name*</label>
                                <div class="search-input-wrapper">
                                    ...
                                    <input
                                        ...
                                        id="name"
                                        value="{{ old('name') }}"
                                        class="search-input @error('name') border-red-500 @enderror"
                                        required
                                    >
                                </div>
                                @error('name')
                            ...
                            <!-- Description -->
                            <div>
                                <label for="description" class="block text-sm font-medium text-[var(--text-dark)] mb-1">Company Description</label>
                                <textarea
                                    name="description"
                                    id="description"
                                    rows="4"
                                    class="w-full px-3 py-2 border border-[var(--border-color)] rounded-md @error('description') border-red-500 @enderror"
                                    placeholder="Tell us about your company, its mission, and vision..."
                            ...
                            <!-- Logo Upload -->
                            <div>
                                <label for="logo" class="block text-sm font-medium text-[var(--text-dark)] mb-1">Company Logo</label>
                                <div class="border border-dashed border-[var(--border-color)] rounded-md p-4 text-center">
                                    ...
                                    <p class="text-sm text-[var(--text-light)] mb-2">Drag and drop your company logo here, or click to browse</p>
                                    <input
                                        type="file"
                                        name="logo"
                                        id="logo"
                            ...
                            <!-- Website URL -->
                            <div>
                                <label for="website_url" class="block text-sm font-medium text-[var(--text-dark)] mb-1">Website URL</label>
                                <div class="search-input-wrapper">
                                ...
                                <div>
                                    ...
                                    <div class="select-wrapper">
                                        ...
                                        >
                                            ...
                                            <option value="1001-5000" {{ old('company_size') == '1001-5000' ? 'selected' : '' }}>1001-5000 employees</option>
                                            <option value="5001+" {{ old('company_size') == '5001+' ? 'selected' : '' }}>5001+ employees</option>
                                        </select>
                                        <div class="select-icon">
                                            <i class="fas fa-chevron-down"></i>
                                        </div>
                                    ...
                                    <div class="select-wrapper">
                                        ...
                                        >
                                            ...
                                            @for($year = date('Y'); $year >= 1900; $year--)
                                                <option value="{{ $year }}" {{ old('founded_year') == $year ? 'selected' : '' }}>{{ $year }}</option>
                                            @endfor
                                        </select>
                                        <div class="select-icon">
                                            <i class="fas fa-chevron-down"></i>
                            ...
                            <!-- Location -->
                            <div>
                                <label for="location" class="block text-sm font-medium text-[var(--text-dark)] mb-1">Company Location</label>
                                <div class="search-input-wrapper">
                        ...
                        <div class="mt-8 flex flex-col space-y-4">
                            <div class="custom-checkbox">
                                ...
                                <label for="terms" class="form-check-label ml-2 text-sm text-[var(--text-dark)]">
                                    I agree to the <a href="#" class="text-[var(--primary-color)] hover:underline">Terms of Service</a> and <a href="#" class="text-[var(--primary-color)] hover:underline">Privacy Policy</a>
                                </label>
                            </div>
                        ...
                        <div class="text-center mt-4">
                            <p class="text-sm text-[var(--text-light)]">
                                Already have a company account? <a href="{{ route('login') }}" class="text-[var(--primary-color)] hover:underline">Sign in</a>
                            </p>
                        </div>
                    </form>
                </div>
