...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-3xl mx-auto bg-white rounded-lg shadow p-6">
            <h1 class="text-2xl font-bold mb-6">Post New Internship</h1>
            ...
            <form action="{{ route('internships.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="requirements" id="requirements" rows="4"
                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('requirements') }}</textarea>
                    @error('requirements')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="application_deadline" id="application_deadline"
                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required value="{{ old('application_deadline') }}">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center mt-3">
                        ...
                        <label for="is_active" class="text-gray-700">Publish immediately</label>
                    </div>
                    @error('is_active')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
